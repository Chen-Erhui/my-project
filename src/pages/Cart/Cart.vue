  ...
  <div class="page-cart">
    ...
    <div class="main">
      ...
      <div class="cart-groups-wraper">
        ...
        <table width="100%">
          <tr class="spline-bottom">
            <td class="group-item-checkbox active">&nbsp;</td>
            <td class="group-item-img">
              <img src="./images/product-list-demo.jpg" alt="">
            </td>
            <td class="group-item-detail">
              ...
              <div class="product-specifics-wrap">
                ...
                <div class="product-operates">
                  ...
                  <span class="product-operates-item">商品数量</span>
                  <span class="inner">+</span>
                </div>
              </div>
            </td>
        ...
        <div class="group-footer spline-bottom pl14 f14">
          ...
          <span class="selectAll selectAll-true">全选</span>
          共：<span class="redfont">￥32.0</span>
